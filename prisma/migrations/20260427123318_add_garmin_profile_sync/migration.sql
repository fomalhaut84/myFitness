...
ALTER TABLE "UserProfile"
  ...
  ADD COLUMN "restingHRBaseSource" TEXT,
...
-- 기존 사용자 데이터 보호: 마이그레이션 전 수동 입력된 maxHR/lthr/lthrPace/restingHRBase를 'manual' 표시.
...
UPDATE "UserProfile" SET "restingHRBaseSource" = 'manual' WHERE "restingHRBase" IS NOT NULL;
...
ALTER TABLE "UserProfile"
  ...
  ADD CONSTRAINT "UserProfile_restingHRBaseSource_check"
    CHECK ("restingHRBaseSource" IS NULL OR "restingHRBaseSource" IN ('manual', 'garmin'));
