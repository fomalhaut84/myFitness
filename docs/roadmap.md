...
- 이슈: #394 (PR #402 · v2.31.0) · 후속 #403 (프로세스 간 캐시 무효화) · #405 (하한 > 오늘 방어)
...
- 이슈: #395 (PR #407 · v2.32.0 · 배포 후 실데이터 확인 2026-09-21) · 후속 #408 (기록 시작일이 걸린 첫 버킷) · `/trends` → `/history` 링크의 지표 유지는 #396 에 편입
...
- 이슈: #396 · PR #412 · **v2.33.0** (2026-09-22) · 프로덕션 백필 완료 (race 14). 후속: #413 (포인트 클릭 접근성) · #414 (과거 활동 재조회)

## M15-5: 심화 시각화 — 우선순위 ★ ✅

- [x] 효율 산점도 · HR 존 분포 · 기상 vs 페이스 · 교차 상관 (주간 km → 다음 주 RHR) 4개 선별 → `/insights` (수면 규칙성은 `/lifestyle` 에 이미 있어 제외)
- 이슈: #397 · PR #417 · **v2.34.0** (2026-09-22). 미선별 후보는 #397 체크리스트 · D8 표. 후속: #419 (RSC 페이로드 · 레이스 점 연도 색 · 제외 사유) · #418 (HRR)
...
- 이슈: #444 · PR #456 · fix PR #458 (릴리즈 PR Codex P2 — `hrrDrop10` 안내 단위) · **v2.38.0** (2026-09-24). 스펙 `docs/specs/444-report-evidence.md`. Phase 2: #455 (개인 기록 도구 · 체지방/근육량 · 강도 분 · 수면 규칙성 · 다이나믹스 추세)
