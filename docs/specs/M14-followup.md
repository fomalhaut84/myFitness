...
## 현재 상태 (2026-09-24, v2.37.0 배포 · #445 머지 · v2.37.1 릴리즈 준비)
...
| **#445 월별 그리드 월요일 시작** (P2) | **완료 (PR #452 머지 2026-09-24) → v2.37.1 릴리즈** | `month-cells.ts` 정본 · `MonthlyHeatmap` 로컬 TZ 제거. 봇 미도착 (사전 리뷰가 완료 판정). 다음: #444 Phase 1 기획 |
