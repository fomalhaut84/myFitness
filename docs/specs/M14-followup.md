...
| **#445 월별 그리드 월요일 시작** (P2) | **완료 (PR #452 머지 2026-09-24)** — 릴리즈는 위 행 | `month-cells.ts` 정본 · `MonthlyHeatmap` 로컬 TZ 제거. 봇 미도착 (사전 리뷰가 완료 판정). 다음: #444 Phase 1 기획 (스펙 초안 `444-report-evidence.md`) |
