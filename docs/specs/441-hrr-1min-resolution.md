...
- [x] F1 **프로덕션 현재 분포** (설정 변경 전 기준값) — 사용자 실행 (결과 §5):
  ```bash
...
**F1 기준값 (프로덕션 · 2026-09-23 23:32 KST · 사용자 실행, 이슈 댓글):**

| 월 | 120초 | 60초 | 기타 | 일수 |
|---|---|---|---|---|
| 2026-04 | 7,618 | 0 | 12 | 11 |
| 2026-05 | 21,426 | 0 | 37 | 31 |
| 2026-06 | 20,647 | 0 | 38 | 30 |
| 2026-07 | 21,477 | 0 | 32 | 31 |
| 2026-08 | 21,339 | 0 | 39 | 31 |
| 2026-09 | 15,123 | 0 | 25 | 22 |

전 월 60초 0건 — 현재 설정에서 하루 심박은 **2분 격자**다 (기타는 null 구간의 240초 이상 간격). 2026-04 이전은 시계열 없음 (#431 보존 창).

_(F2 워치 "매초" 설정 실험 결과는 여기에)_
